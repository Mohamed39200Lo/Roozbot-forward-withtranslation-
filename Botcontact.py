...
bot = telebot.TeleBot('7674278704:AAEiNgwTIQfKpyxKk5M353NN5UN8YRguhFo')
...
def create_inline_keyboard():
    ...
    btn6 = types.InlineKeyboardButton('لدي مشكلة في طلبي بعد الاستلام اريد ارجاعه 📫', callback_data='return_request')
    btn5 = types.InlineKeyboardButton('شاركنا تجاربك ❤️ ', url='https://t.me/roozbrands_bot')
